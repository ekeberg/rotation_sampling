...
MOD_INIT(rotsampling)
{
  import_array();
  PyObject *module;
  MOD_DEF(module, "rotsampling", "Sample rotation space.", RotsamplingMethods)
  if (module == NULL)
...
/*   "rotmodule",      /\* m_name *\/ */
/*   "Sample rotation space.", /\* m_doc *\/ */
/*   -1,          /\* m_size *\/ */
/*   RotsamplingMethods, /\* m_methods *\/ */
/*   NULL,        /\* m_reload *\/ */
/*   NULL,        /\* m_traverse *\/ */
/*   NULL,        /\* m_clear *\/ */
/*   NULL,        /\* m_free *\/ */
...
/* #ifdef IS_PY3 */
/*   PyMODINIT_FUNC PyInit_rotsampling(void) */
/* #else */
...
/*   #else */
/*     PyObject *module = Py_InitModule3("rotsampling", RotsamplingMethods, "Sample rotation space"); */
/*   #endif */
